...
cd ~/bot-kt
wget https://raw.githubusercontent.com/l1ving/bot-kt/master/scripts/bot-kt.service
wget https://raw.githubusercontent.com/l1ving/bot-kt/master/scripts/bot-kt.timer
wget https://raw.githubusercontent.com/l1ving/bot-kt/master/scripts/start.sh
